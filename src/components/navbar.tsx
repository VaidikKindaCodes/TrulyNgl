...
export function NavbarComp() {
  ...
  return (
    <nav className="flex w-full items-center justify-between bg-black border-b border-gray-800 px-4 py-3 shadow-sm">
      ...
      <div className="flex items-center gap-2">
        {session ? (
          <>
            <span className="hidden xs:inline mr-2 text-sm md:text-lg text-white truncate max-w-[100px] md:max-w-none">
